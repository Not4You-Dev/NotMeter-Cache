(() => {
  ...
  const COPY = {
    ko: {
      ...
      rankerGuideFrozenExcluded: "무스펠의 성배는 랭커 마크·랭킹 닉네임 효과 대상에서 제외됩니다. 비탄의 설원은 보통·어려움의 트리톤과 델트라스 2페이즈만 해당합니다.",
      ...
      rankerDungeonGuideBakronReward: "시련: 바크론의 공중섬은 랭커 마크와 TOP 3 닉네임 효과 대상입니다.",
    ...
    en: {
      ...
      rankerGuideFrozenExcluded: "Musphel's Grail is excluded from rank markers and ranking-based nickname effects. Snowfield eligibility covers only Triton and Deltras phase 2 on Normal and Hard.",
      ...
      rankerDungeonGuideBakronReward: "Trial: Bakron's Sky Island qualifies for rank markers and Top 3 nickname effects.",
