(() => {
  ...
  const PUBLIC_CACHE_REF_URL = "https://api.github.com/repos/Not4You-Dev/NotMeter-Cache/commits?path=presence/notmeter-artifact-occupation-public.json&per_page=1";
  const EXPECTED_SCHEMA = "notmeter-artifact-occupation-public-v1";
  const EXPECTED_REVISION = "kr-2026-09-23";
